class Help {
  ...
  void displayHelp() {
    if (hStart == true) {
      ...
      text("Studiepoeng er p / p to credits",width/2,220);
      ...
      text("Elementene er en gang kjøp! / Items are a one time buy!", width/2,200);
      fill(0);
      rectMode(CENTER);
  ...
  void showHelpButton() {
    if (norseBackground == true) {
      ...
      text("Press p for credits",width/2+430,height/2-110);
      fill(0);
    } else {
      fill(255);
      text("Press i for help", width/2+430, height/2-130);
