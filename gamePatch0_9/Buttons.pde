class Buttons {
  ...
  void buttonsToPress() {
    ...
    if (key == 'c'&& rStart == true && shopPageOne == false && newChest.coin >= 20) {
      theShop.buyBackgroundFive();
    ...
    if (key == 'ø') {
      //Bare for norske!
      boxKnife.knifeCount = boxKnife.knifeCount + 50;
      newChest.coin = newChest.coin + 50;
      playNorse = true; 
      playRain = false;
      norseBackground = true;
      changeDeer = false;
