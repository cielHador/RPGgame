...
Score myScore;
Chest newChest;
AudioPlayer walkOneStep, walkTwoStep, walkThreeStep, jump, musicOne, musicTwo, noises, coinSound, monsterSoundScore, norseSong;
boolean start, rStart, hStart, creditsScreen, bought2000, bought4000, changeDeer, startBackground, changeCastle, changeOriginal, shopPageTwo, shopPageOne, 
  norseBackground, playRain, playNorse;
Credits credits;
Buttons button;
Noises newNoise;
Bat bat;
...
void setup() {
  ...
  norseSong = minim.loadFile("Norse.mp3");
  start = false;
